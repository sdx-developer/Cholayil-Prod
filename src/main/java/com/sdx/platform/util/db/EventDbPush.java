...
public class EventDbPush {
	...
	public List getMachineMetricsFailureDetails() {
		...
		for (MachineMetricsFailures metrics : MachineFailureService.findAllDec()) {
	...
	public void update(int transid) {
		MachineMetricsFailures machineMetricsFailures = MachineFailureService.findById(transid);
		//System.out.println(":::::::::::::::::inside the update :::::::::::::::"+machineMetricsFailures.getRetrycount());
		machineMetricsFailures.setRetrycount(machineMetricsFailures.getRetrycount() + 1);
